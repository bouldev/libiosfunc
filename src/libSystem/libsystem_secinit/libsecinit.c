...
extern void container_delete_all_data_container_content_for_current_user(void);
...
void libsecinit_delete_all_data_container_content_for_current_user(void){
    return container_delete_all_data_container_content_for_current_user();
}
